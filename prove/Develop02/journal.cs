...
public class Journal
{
    ...
    private readonly string[] prompts = {
        ...
        "Write something nice that happened today!",
        "How am I doing with my recent goals?"
    };
...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (running)
        {
            Console.WriteLine("This is your journal, it does not matter how much I write or not write by session be yourself ^^, Menu:");
